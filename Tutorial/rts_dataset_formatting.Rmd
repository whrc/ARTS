...
your_file = 'RTS_NESiberia_Runge_meta.shp'  # set this
dataset_version = 'v.18.0.0' # set this to the most recent version
...
#new_fields = c('Status'='Status')
#new_fields_abbreviated = c('Status')

#new_fields = c('Notes'='Notes', 'Status'='Status')
#new_fields_abbreviated = c('Notes', 'Status')
...
Add the 'RepeatRTS', 'StabilizedRTS', 'NewRTS', 'MergedRTS', 'SplitRTS', 'AccidentalOverlap', or 'UnknownRelationship' columns that you just edited back into `new_dataset`.
