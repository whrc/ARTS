...
your_file = 'rts_Positive_Yang.shp'  # set this
dataset_version = 'v.19.0.0' # set this to the most recent version
...
When this is done, each of the UIDs in the 'Intersections' and 'SelfIntersections' columns should have been copied into one (and only one) of the 'RepeatRTS', 'RepeatNegative', 'StabilizedRTS', 'NewRTS', 'MergedRTS', 'SplitRTS', 'AccidentalOverlap', 'FalseNegative', and 'UnknownRelationship' columns.
...
if (nrow(
  merged_data |>
    filter(TrainClass == 'Positive' & str_length(FalseNegative) > 0)) > 0
) {
